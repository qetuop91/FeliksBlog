/*
 ...
 Source Server         : 192.168.57.1
 Source Server Type    : MySQL
 Source Server Version : 80031
 Source Host           : 192.168.57.1:3306
...
INSERT INTO `sg_article` VALUES (2, 'weq', 'adadaeqe', 'adad', 2, 'https://sg-blog-oss.oss-cn-beijing.aliyuncs.com/2022/01/15/fd2e9460c58a4af3bbeae5d9ed581688.png', '1', '0', 22, '0', NULL, '2022-01-21 14:58:30', NULL, NULL, 0);
...
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '文章标签关联表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `sg_tag`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 6 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '标签' ROW_FORMAT = Dynamic;
...
-- Records of sys_role
-- ----------------------------
INSERT INTO `sys_role` VALUES (1, '超级管理员', 'admin', 1, '0', '0', 0, '2023-09-13 00:22:19', 0, NULL, '超级管理员');
INSERT INTO `sys_role` VALUES (2, '友链审核员', 'link', 1, '0', '0', NULL, '2023-09-13 00:22:19', NULL, '2023-09-13 00:22:19', '友链审核员');
INSERT INTO `sys_role` VALUES (3, '普通角色', 'common', 2, '0', '0', 0, '2023-09-13 00:22:19', 0, '2023-09-13 00:22:19', '普通角色');
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES (1, 'Feliks', 'hzx', '$2a$10$NRX4AukRtdHqZqUKkMLKnOk/2WP0uuk8MCkvWNNAv5/ipoL3vr5D6', '1', '0', '983480256@qq.com', '13609777573', '0', 'https://gimg2.baidu.com/image_search/src=http%3A%2F%2Fi0.hdslb.com%2Fbfs%2Farticle%2F3bf9c263bc0f2ac5c3a7feb9e218d07475573ec8.gi', NULL, '2022-01-05 09:01:56', NULL, '2023-09-13 00:38:05', 0);
