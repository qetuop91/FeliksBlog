...
<div class="">
	...
	<!-- <div class="headImgBox" :style="{backgroundImage:this.$store.state.themeObj.top_image?'url('+this.$store.state.themeObj.top_image+')':'url(static/img/wlop4_1.jpg)'}"> -->
		<div class="scene">
		...
		<div class="h-information">
                    ...
                    <!-- <img :src="this.$store.state.themeObj.head_portrait?this.$store.state.themeObj.head_portrait:userInfo.avatar" alt=""> -->
			<h2 class="h-description">

                        {{this.$store.state.themeObj.autograph?this.$store.state.themeObj.autograph:"Ciallo～(∠・ω< )⌒☆"}}
